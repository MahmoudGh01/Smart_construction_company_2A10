...
q1.prepare("SELECT * FROM stockp");
q1.exec();

q2.prepare("SELECT * FROM stockp WHERE adresse='adresse 1'");
q2.exec();

q3.prepare("SELECT * FROM stockp WHERE adresse='adresse 2'");
q3.exec();

q4.prepare("SELECT * FROM stockp WHERE adresse='adresse 3' ");
q4.exec();

q5.prepare("SELECT * FROM stockp WHERE adresse='adresse 4' ");
q5.exec();
...
//pie chart
    ...
    q2.prepare("SELECT * FROM stockp WHERE prix between 0 and 1000");
    q2.exec();

    q3.prepare("SELECT * FROM stockp WHERE prix between 1001 and 2000");
    q3.exec();

    q4.prepare("SELECT * FROM stockp WHERE prix > 2000 ");
    q4.exec();
